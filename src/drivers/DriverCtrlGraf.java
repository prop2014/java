		...
		while(opcion != 25){
			...
			switch(opcion){
				...
				case 0:{
					...
					System.out.print("26: Llenar Grafo\n");
					System.out.print("25: Fi de l'aplicatiu\n");
					System.out.print("\n");
					break;
				}
				...
				case 26:{
					...
					for(int i : nodos) {
						Nodo nod = g.getNode(i);
						System.out.printf("\nDOCTOR: Nodo tipo: %s con id %d ", nod.getTipo(), i);
						for(int j : g.getOutNodes(i)){
							Nodo nod2 = g.getNode(j);
							System.out.printf("TURNO: Nodo tipo: %s con id %d Conectado con %d", nod2.getTipo(), j, g.getOutNodes(j).get(0));
						}
					}
					break;
				}
